...
('You Don’t Know JS', 'Kyle Simpson', "O'Reilly Media", '2015-03-27'),
('JavaScript: The Good Parts', 'Douglas Crockford', "O'Reilly Media", '2008-05-15'),
('Effective Java', 'Joshua Bloch', 'Addison-Wesley', '2008-05-28'),
('Head First Design Patterns', 'Eric Freeman', "O'Reilly Media", '2004-10-25'),
...
('Learning React', 'Alex Banks', "O'Reilly Media", '2020-01-10'),
('Programming TypeScript', 'Boris Cherny', "O'Reilly Media", '2019-05-20'),
('Kubernetes Up & Running', 'Brendan Burns', "O'Reilly Media", '2019-11-14'),
('Docker Deep Dive', 'Nigel Poulton', 'Leanpub', '2018-06-30'),
('Site Reliability Engineering', 'Betsy Beyer', "O'Reilly Media", '2016-03-23');
